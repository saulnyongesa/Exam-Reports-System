"""
Django settings for reportMIS project.
...
SECRET_KEY = 'django-insecure-sw=l=8tvx0famuwj^rqq=55@62xvq7sx_#=#m_n8%(!_(7(58p'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'reports.context_processors.remaining_days',
...
WSGI_APPLICATION = 'reportMIS.wsgi.application'
